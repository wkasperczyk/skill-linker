...
│
├── examples/                   # Examples (MVI)
│   ├── navigation.md
│   └── skill-linker.md       # NEW: .NET CLI tool example
│
├── lookup/                     # Quick reference (MVI)
│   ├── navigation.md
│   └── tool-paths.md          # NEW: Tool default paths
│
...
| **Skill-linker example** | `examples/skill-linker.md` |
| **Tool paths** | `lookup/tool-paths.md` |
...
**Examples** → Working code examples (skill-linker, etc.)
**Lookup** → Quick reference (tool paths, commands)
